...
async def gen_thumb(videoid: str, thumb_size=(1280, 720)):
    ...
    try:
        ...
        font_small = ImageFont.truetype("ShrutiMusic/assets/font2.ttf", 30)
        font_title = ImageFont.truetype("ShrutiMusic/assets/font3.ttf", 45)
        ...
        icons = Image.open("ShrutiMusic/assets/play_icons.png").convert("RGBA")
